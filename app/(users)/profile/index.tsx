...
import { fetchUserProfile, updateUserProfile, uploadAvatar, deleteAvatar } from "@/lib/profileService";
import { fetchServiceProviderProfile, updateServiceProviderProfile, uploadProviderAvatar, fetchUserProviderServices, ProviderServiceWithDetails, toggleServiceStatus, deleteProviderService, uploadLicenseImage, updateServiceProviderLicense, deleteLicenseImage, deleteProviderAvatar } from "@/lib/servicesService";
...
export default function ProfileScreen() {
  ...
  const [verificationStatus, setVerificationStatus] = useState<'verified' | 'not_verified' | 'pending'>('not_verified');
  ...
  const [serviceToEdit, setServiceToEdit] = useState<ProviderServiceWithDetails | null>(null);
    ...
    try {
      ...
      if (!result.canceled && result.assets[0]) {
        ...
        try {
          ...
          const publicUrl = await uploadProviderAvatar(imageUri, currentUser.id);
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              showSuccessPopup(`Service ${newStatus ? 'activated' : 'deactivated'} successfully`);
            } catch (error: any) {
              showErrorPopup(error.message || 'Failed to update service status');
            }
          }
        }
      ]
  ...
  const uploadLicenseDocument = async (imageUri: string) => {
    ...
    try {
      ...
      Haptics.notificationAsync(NotificationFeedbackType.Success);
      showSuccessPopup("License document uploaded successfully. Pending verification.");
    } catch (uploadError) {
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              showErrorPopup('Failed to remove profile picture. Please try again.');
            }
          }
        }
      ]
            ...
            try {
              ...
              if (licenseImageUrl) {
                try {
                  ...
                  console.error('Failed to delete license from storage:', error);
                }
              }
    ...
    <View className="flex-1 bg-white">
      ...
      <View style={{ paddingTop: 120 }} className="flex-1">
        ...
        <View className="bg-white border-b border-gray-100">
          <View className="flex-row">
            ...
            <TouchableOpacity className={`flex-1 py-4 items-center border-b-2 ${activeTab === "services" ? "border-primary" : "border-transparent"}`} onPress={() => setActiveTab("services")}>
              ...
              <Text className={`font-msemibold text-xs ${activeTab === "services" ? "text-primary" : "text-gray-500"}`}>Service</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View className="px-4 py-4">
          ...
          {activeTab === "services" && <Text className="text-center py-8 text-gray-500">Services coming soon</Text>}
        </View>
        <View className="h-8" />
          </ScrollView>
        </View>
              ...
              <View className="px-4 py-6">
                ...
                <View className="bg-white rounded-2xl p-6 mb-4 shadow-sm">
                  ...
                  <View className="flex-row items-center justify-between mb-6">
                    <Text className="text-xl font-mbold text-gray-900">Service Provider Profile</Text>
                    ...
                    {isEditingProvider ? (
                      <View className="flex-row gap-2">
                        ...
                        >
                          <Text className="text-gray-700 font-msemibold text-sm">Cancel</Text>
                        </TouchableOpacity>
                      </View>
                    ) : (
                      <View className="flex-row items-center gap-2">
                  ...
                  <View className="items-center mb-6">
                    <View className="relative mb-4">
                      <View className="w-24 h-24 rounded-full bg-gray-200 items-center justify-center overflow-hidden">
                        {providerImageUri ? (
                          <Image source={{ uri: providerImageUri }} className="w-24 h-24 rounded-full" resizeMode="cover" />
                        ) : (
                    ...
                    <View className="mb-4">
                      ...
                      {isEditingProvider ? (
                        <TextInput
                          ...
                          onChangeText={(text) => setProviderFormData({...providerFormData, businessName: text})}
                        />
                      ) : (
                        <View className="bg-gray-50 rounded-xl px-4 py-3">
                          <Text className="text-base font-regular text-gray-400 italic">Not set</Text>
                        </View>
                      )}
                    </View>
                    ...
                    <View className="mb-4">
                      ...
                      {isEditingProvider ? (
                        <TextInput
                          ...
                          onChangeText={(text) => setProviderFormData({...providerFormData, bio: text})}
                          multiline
                          numberOfLines={4}
                        ...
                        <View className="bg-gray-50 rounded-xl px-4 py-3">
                          <Text className="text-base font-regular text-gray-900">
                            {providerFormData.bio || <Text className="italic text-gray-400">Not set</Text>}
                          </Text>
                        </View>
                      )}
                    </View>
                ...
                <View className="bg-white rounded-2xl p-6 mb-4 shadow-sm">
                  <View className="flex-row items-center justify-between mb-4">
                    <View className="flex-row items-center">
                      ...
                      <Text className="text-lg font-mbold text-gray-900">License Verification</Text>
                    </View>
                    <View className="flex-row items-center gap-2">
                      {!uploadingLicense && verificationStatus !== 'not_verified' && (
                        <View className={`px-3 py-1 rounded-full ${
                          ...
                          <Text className={`text-xs font-msemibold ${
                            verificationStatus === 'verified'
                              ? 'text-green-700'
                              : 'text-yellow-700'
                          }`}>
                  ...
                  {uploadingLicense ? (
                    <View className="flex-row items-center justify-center py-3">
                      ...
                      <Text className="text-primary font-msemibold ml-3">Processing document...</Text>
                    </View>
                  ) : !licenseImageUrl ? (
                    <TouchableOpacity
                ...
                <View className="bg-white rounded-2xl p-6 shadow-sm">
                  <Text className="text-lg font-mbold text-gray-900 mb-2">Your Services</Text>
                  <Text className="text-sm text-gray-500 mb-4">
                    ...
                    <View className="space-y-3">
                      {providerServices.map((service) => (
                        ...
                        >
                          <TouchableOpacity
                            activeOpacity={0.8}
                            onLongPress={() => handleServiceLongPress(service.id)}
                            onPress={() =>
                              ...
                              {!isServiceSelectionMode && (
                                <View className="items-center justify-between ml-2">
                                  ...
                                  <View className="items-center mb-2">
                                    ...
                                    />
                                    <Text className={`text-[10px] font-msemibold mt-1 ${
                ...
                {isServiceSelectionMode && selectedServiceIds.length > 0 && (
                  ...
                  >
                    <View>
                      <Text className="text-white font-mbold text-lg">{selectedServiceIds.length}</Text>
      ...
      {/* ------------------------------------------------------ */}
      {showMainAvatarMenu && (
        <Modal transparent statusBarTranslucent animationType="none" visible={showMainAvatarMenu} onRequestClose={() => setShowMainAvatarMenu(false)}>
          <View className="flex-1 justify-end">
            ...
            <Animated.View entering={SlideInDown.springify()} exiting={SlideOutDown} style={{ backgroundColor: "white", borderTopLeftRadius: 24, borderTopRightRadius: 24 }}>
              <View className="w-full items-center pt-5 pb-4 bg-white rounded-t-3xl">
                <View className="w-12 h-1.5 bg-gray-300 rounded-full" />
              </View>

              <View className="px-6 pb-6">
                <Text className="text-xl font-mbold text-gray-900 mb-6 text-center">Profile Picture Options</Text>
                ...
                >
                  <Camera size={24} className="text-gray-700 mr-4" />
                  <View>
                    <Text className="text-base font-msemibold text-gray-900">Change Photo</Text>
                    <Text className="text-sm font-regular text-gray-500">Take a new photo or choose from gallery</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  ...
                  <View>
                    <Text className="text-base font-msemibold text-red-600">Remove Photo</Text>
                    <Text className="text-sm font-regular text-red-400">Delete your profile picture</Text>
                  </View>
                </TouchableOpacity>
      ...
      {showProviderImagePicker && (
        <Modal transparent statusBarTranslucent animationType="slide" visible={showProviderImagePicker} onRequestClose={() => setShowProviderImagePicker(false)}>
          <View className="flex-1 justify-end">
            <TouchableOpacity
              style={{ position: "absolute", top: 0, bottom: 0, left: 0, right: 0, backgroundColor: "rgba(0,0,0,0.5)" }}
              activeOpacity={1}
            ...
            <View style={{ backgroundColor: "white", borderTopLeftRadius: 24, borderTopRightRadius: 24 }}>
              ...
              <View className="px-6 pb-6">
                <Text className="text-xl font-mbold text-gray-900 mb-6 text-center">Change Service Provider Photo</Text>

                <TouchableOpacity onPress={() => handleProviderImageOption("camera")} className="flex-row items-center bg-gray-50 rounded-xl px-4 py-4 mb-3">
                  <Camera size={24} className="text-gray-700 mr-4" />
                  <View>
                    <Text className="text-base font-msemibold text-gray-900">Take Photo</Text>
                    <Text className="text-sm font-regular text-gray-500">Use camera to take a new photo</Text>
                ...
                <TouchableOpacity onPress={() => handleProviderImageOption("gallery")} className="flex-row items-center bg-gray-50 rounded-xl px-4 py-4 mb-6">
                  <ImageIcon size={24} className="text-gray-700 mr-4" />
                  <View>
                    <Text className="text-base font-msemibold text-gray-900">Choose from Gallery</Text>
                    <Text className="text-sm font-regular text-gray-500">Select from your photo library</Text>
      ...
      {showProviderAvatarMenu && (
        <Modal transparent statusBarTranslucent animationType="none" visible={showProviderAvatarMenu} onRequestClose={() => setShowProviderAvatarMenu(false)}>
          <View className="flex-1 justify-end">
            <Animated.View entering={FadeIn} exiting={FadeOut}>
              <TouchableOpacity
                style={{ position: "absolute", top: 0, bottom: 0, left: 0, right: 0, backgroundColor: "rgba(0,0,0,0.5)" }}
            ...
            <Animated.View entering={SlideInDown.springify()} exiting={SlideOutDown} style={{ backgroundColor: "white", borderTopLeftRadius: 24, borderTopRightRadius: 24 }}>
              ...
              <View className="px-6 pb-6">
                <Text className="text-xl font-mbold text-gray-900 mb-6 text-center">Avatar Options</Text>
                ...
                >
                  ...
                  <View>
                    <Text className="text-base font-msemibold text-red-600">Remove Photo</Text>
                    <Text className="text-sm font-regular text-red-400">Delete your service provider avatar</Text>
                  </View>
                </TouchableOpacity>
      ...
      {/* ------------------------------------------------------ */}
      {showLicenseMenu && (
        <Modal transparent statusBarTranslucent animationType="none" visible={showLicenseMenu} onRequestClose={() => setShowLicenseMenu(false)}>
          <View className="flex-1 justify-end">
            <Animated.View entering={FadeIn} exiting={FadeOut}>
              <TouchableOpacity
                style={{ position: "absolute", top: 0, bottom: 0, left: 0, right: 0, backgroundColor: "rgba(0,0,0,0.5)" }}
            ...
            <Animated.View entering={SlideInDown.springify()} exiting={SlideOutDown} style={{ backgroundColor: "white", borderTopLeftRadius: 24, borderTopRightRadius: 24 }}>
              ...
              <View className="px-6 pb-6">
                <Text className="text-xl font-mbold text-gray-900 mb-6 text-center">License Options</Text>
                ...
                >
                  ...
                  <View>
                    <Text className="text-base font-msemibold text-gray-900">View License</Text>
                    <Text className="text-sm font-regular text-gray-500">See your uploaded license document</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  ...
                  <View>
                    <Text className="text-base font-msemibold text-gray-900">Replace License</Text>
                    <Text className="text-sm font-regular text-gray-500">Upload a new license document</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <Trash2 size={24} className="text-red-600 mr-4" />
                  <View>
                    <Text className="text-base font-msemibold text-red-600">Remove License</Text>
                    <Text className="text-sm font-regular text-red-400">Delete license and reset verification</Text>
                  </View>
                </TouchableOpacity>
